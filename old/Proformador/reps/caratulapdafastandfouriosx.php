            ...
            <tr>
              <td width="637" height="90" align="left" class="normal" ><table width="646" border="1" cellspacing="0">
                <tr>
                  ...
                  <td width="372"><font color="#FFFFFF"><img src="top.jpg" width="285" height="83" /></font></td>
                </tr>
              </table></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><table width="640" border="1" cellspacing="0" bordercolor="#CCCCCC">
                ...
                <tr class="normalA">
                  ...
                  <td align="right"><input class="generalCombo" type="text" name="<?php echo $item."importe"; ?>" id="textfield" align="right" size="20" value="$ <?php echo number_format($rowRef["importe"], 2, ".", ","); ?>"/>
                    <?php
            ...
            <tr>
              <td><table width="640" border="1" cellspacing="0" bordercolor="#CCCCCC">
                ...
                <tr class="normalA">
                  <td><?php echo $item; ?></td>
                  <td><input type="text" name="<?php echo $item."referencia"; ?>" id="textfield" class="generalCombo" readonly="true" size="60" value="<?php echo $rowRef["referencia"]; ?>"/></td>
                  <td align="right"><input class="generalCombo" type="text" name="<?php echo $item."importe"; ?>" id="textfield" align="right" size="20" value="$ <?php echo number_format($rowRef["importe"]/$tc, 2, ".", ","); ?>"/>
                    <?php
                                            $val=str_replace( ",", "", $rowRef["importe"]);
                                            $val=str_replace( "$", "", $val);
                                            $subtot1+=$val; ?></td>
            ...
            <tr>
              <td width="637" height="90" align="left" class="normal" ><table width="646" border="1" cellspacing="0">
                <tr>
                  ...
                  <td width="372"><font color="#FFFFFF"><img src="top.jpg" alt="" width="285" height="83" /></font></td>
                </tr>
              </table></td>
            </tr>
            <tr>
                ...
                <tr>
                    <td><table width="650" border="1" cellspacing="0" bordercolor="#CCCCCC">
                            ...
                            <tr class="normalA">
                                <td><?php echo $item; ?></td>
                                <td><?php echo $rowRef["referencia"]; ?></td>
                                <td align="right">$ <?php echo number_format($rowRef["importe"], 2, ".", ",");
                                        $val=str_replace( ",", "", $rowRef["importe"]);
                                        $val=str_replace( "$", "", $val);
                                        $subtot1+=$val; ?></td>
                                <td>&nbsp;</td>
