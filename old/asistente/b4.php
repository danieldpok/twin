...
<body class="texto">
id=<?php echo $id; ?>
<form name="form1" id="form1" method="get" action="b5.php" target="formFrame">
...
Bodega: <input type="text" name="bodega" value="<?php echo $bodega; ?>" readonly="readonly" class="textoField" size="5"  /><br />
