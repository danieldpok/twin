...
<body class="texto">
id=<?php echo $id; ?><br />
A continuación escriba el peso que se descargara en el primer puerto:<br />
<form name="producto" target="formFrame" method="get" action="bod7.php">
...
<input type="text" name="cantidad1" size="10"  />MT.
