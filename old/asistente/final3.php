...
<body class="texto">
  <img src="http://server-twinmarine.homelinux.com/twin/logox.jpg" width="264" height="83" />
  <?php
...
</table><br /><?php	}	if(isset($_GET["receiver"]))	{?>
...
</table><br /><?php	}	if(isset($_GET["product"]))	{?>
