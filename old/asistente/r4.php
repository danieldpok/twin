...
<body class="texto">
id=<?php echo $id; ?>
<form name="form1" id="form1" method="get" action="r5.php" target="formFrame">
...
Recibidor: <input type="text" name="recibidor" value="<?php echo $recibidor; ?>" readonly="readonly" class="textoField" size="5"  /><br />
