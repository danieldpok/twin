...
$link=Conectar();
$query="insert into descargarecibidor (id, fecha, operacion, recibidor, cantidad) values ('$id', '$fecha', '$operacion', '$recibidor', '$cantidad')";
...
<form name="productoForm" target="formFrame" method="get" action="p1.php">
