...
<div id="dhtmlgoodies_xpPane">
	<div class="dhtmlgoodies_panel">
		<div>
           ...
           <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/nor.php" method="get">
  ...
  <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
           <p> Ingrese ID del Reporte a Consultar...
           <form action="formato.php" method="get">
			    <input type="text" name="id" value="" />
		     <input name="Enviar" type="submit" value="Enviar" />
                <p>&nbsp;</p>
          </form></p>
	...
	<div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			<p>Ingrese ID del Reporte a Consultar...
            <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/timecalc.php" method="get">
                <input type="text" name="id" value="">
                <input name="Enviar" type="submit" value="Enviar" >
                <p>&nbsp;</p>
            </form>
   ...
   <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
            <p>Ingrese ID del Reporte a Consultar...
<form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/edicionestadisticasfacts.php" method="get">
                <input type="text" name="id" value="">
                <input name="Enviar" type="submit" value="Enviar" >
    <p>&nbsp;</p>
            </form>	
...
<div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
		  <p>Ingrese ID del Reporte a Consultar...
            <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/previo.php" method="get">
                <input type="text" name="id" value="">
                <input name="Enviar" type="submit" value="Enviar" >
                <p>&nbsp;</p>
            </form>
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			 <p>Ingrese ID del Reporte a Consultar...
            <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/charges.php" method="get">
                <p>
                  <input type="text" name="id" value="">
                </p>
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			<p>Ingrese ID del Reporte a Consultar...</p>
              <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/actafinalizacion.php" method="get">
                <input type="text" name="id" value="">
                <input name="Enviar" type="submit" value="Enviar" >
                <p>&nbsp;</p>
              </form>		
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			<p>Ingrese ID del Reporte a Consultar...</p>
              <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/reportegral.php" method="get">
                <input type="text" name="id" value="">
                <input name="Enviar" type="submit" value="Enviar" >
                <p>&nbsp;</p>
              </form>			
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			 <p>Ingrese ID del Reporte a Consultar...</p>
              <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/reportegralturno.php" method="get">
                <p>
                  <input type="text" name="id" value="">
                </p>
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			<p>Ingrese ID del Reporte a Consultar...</p>
              <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/reportegralxdia.php" method="get">
                <p>
                  <input type="text" name="id" value="">
                </p>
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			 <p>Ingrese ID del Reporte a Consultar...</p>
              <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/reportegralbodega.php" method="get">
                <input type="text" name="id" value="">
                <input name="Enviar" type="submit" value="Enviar" >
                <p>&nbsp;</p>
              </form>
    ...
    <div class="dhtmlgoodies_panel">
		<div>
			<!-- Start content of pane -->
			<form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/listaanticipos.php" method="get">
    ...
    <div class="dhtmlgoodies_panel">
		<div>
    <p> Ingrese ID del Reporte a Consultar...
           <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/soloestadisticasfacts.php" method="get">
			    <input type="text" name="id" value="" />
		     <input name="Enviar" type="submit" value="Enviar" />
                <p>&nbsp;</p>
          </form></p>
		...
		<div>
    <p> Ingrese ID del Reporte a Consultar...
           <form action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/twin/timecalcform.php" method="get">
			    <input type="text" name="id" value="" />
		     <input name="Enviar" type="submit" value="Enviar" />
                <p>&nbsp;</p>
          </form></p>
...
*/
initDhtmlgoodies_xpPane(Array('NOTICE OF READINEES', 'FORMATOS','Estado de Hechos','Computo de Tiempo','Estadisticas Edo.Hechos','Reporte Previo','Reporte Gral.Status','Reporte Preliminar','Reporte de Oper. en 24 hrs','Acta de Finalizacion','Reporte de Supervision','Supervision por Turnos','Reporte por Día','Reporte por Dest. y Prod.','Reporte por Transportista','Reporte de Bodegas','Rep. de Pagos y Anticipos','Solo Estadisticas','Computo de tiempo Online'),Array(false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false),Array('pane1','pane2','pane3','pane4','pane5','pane6','pane7','pane8','pane9','pane10','pane11','pane12','pane13','pane14','pane15','pane16','panel7','panel18'));
</script>
<!-- END OF PANE CONTENT -->
