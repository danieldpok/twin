...
GENERALES AL BUQUE</b>'), 10, array('justification'=>'center'));
    ...
    $pdf->addText(25,599,10,'MUELLE: <b>'.$row["muelle"].'</b>');     $pdf->addText(300,599,10,'CANAL DE TRABAJO: _________________');
...
<b><u>'.$row["domicilio"].'</b></u>'), 10, array('justification'=>'full'));
