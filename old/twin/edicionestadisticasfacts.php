...
if(isset($_POST["add"]))	{
	...
	$query="insert into computotiempoadicional (id, fecha, hinicial, hfinal, clasif, timepercent) values ('$id', '$fecha', '$hinicial', '$hfinal', '$clasif', '$timepercent')";
	mysql_query($query, $link);
} else if(isset($_POST["update"]))	{
	$clasif=$_POST["clasif"];
	$idcomputotiempoadicional=$_POST["idcomputotiempoadicional"];
	$hinicial=$_POST["hinicial"];
	$hfinal=$_POST["hfinal"];
	$timepercent=$_POST["timepercent"];
	$id=$_POST["id"];
	$query="update computotiempoadicional set hinicial='$hinicial', hfinal='$hfinal', timepercent='$timepercent', clasif='$clasif' where idcomputotiempoadicional='$idcomputotiempoadicional'";
	mysql_query($query, $link);
}	else if(isset($_POST["eliminar"]))	{
	$idcomputotiempoadicional=$_POST["idcomputotiempoadicional"];
	$query="delete from computotiempoadicional where idcomputotiempoadicional='$idcomputotiempoadicional'";
	$id=$_POST["id"];
	mysql_query($query, $link);
}
...
//DATOS DEL REGISTRO
$table="operaciones";
$fields="vessel, puerto, flag, puertodecarga, quantity, cargotype, sofremarks, remarks, typex, timetocount, completedescharging";
...
while($row = mysql_fetch_array($result)) {
    ...
    $completedescharging=$row["completedescharging"];
}
//OBTENER EL TIEMPO DEL BARCO
//////////////////////////////////////////////////////////////////////////
$query="SELECT TIMEDIFF(completedescharging, timetocount) as diff from ".$table." where id='".$id."'";
$result = mysql_query($query, $link);
...
//OBTENER LOS HECHOS
$table="computotiempo";
$fields="fecha, hinicial, hfinal, fact, clasif";
...
/////ANALIZA LOS CONCEPTOS
    $query="select fecha, hinicial, hfinal, clasif, tipo, timepercent from computotiempo where id='$id' and fecha='".$fechax[$i]."' and fecha>='$timetocount1' and clasif!='Seleccionar...' order by hinicial";
    //echo $query;
    ...
    while($row = mysql_fetch_array($result)) {
        ...
        ///////////////CUENTA EL TIEMPO
        if($row["tipo"]=="STOP/IDLE TIME" and $row["clasif"]!="Seleccionar...") {
...
//
///////////////ANALIZA LA INFORMACIÓN ADICIONAL
$query="select fecha, hinicial, hfinal, clasif, timepercent from computotiempoadicional where id='$id' and clasif!='Seleccionar...'";
        ...
        <table width="609" height="190" border="0" align="center">
            <tr>
                <td width="603"><table width="606" border="1" cellspacing="2" cellpadding="0">
                    ...
                    <span class="XXXXXXX">PARA GENERAR TIEMPO EN PUERTO CAPTURE EL &quot;TIME TO COUNT&quot; Y EL &quot;COMPLETED DISCHARGE&quot;</span></br>
                  <table width="407" border="1" align="center">
                    ...
                    <br />
                  <form  name="form2" id="form2" method="post" action="edicionestadisticasfacts.php">
                  <table width="578" border="1">
                      <tr>
                        ...
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Formato no válido.</span></span><input type="button" value="Cal" onclick="displayCalendar(document.forms[0].fecha,'yyyy/mm/dd',this)" /><span id="sprytextfield7">
                        <label>H. Inicial
                  ...
                  <br />
                    ...
                    <table width="641" border="1">
                      ...
                      <?php
					  $query = "select * from computotiempoadicional where id='".$id."'";
					  $result = mysql_query($query, $link);
					  $frm=3;
					  while($row = mysql_fetch_array($result)) {
					  ?>
                      <form id="form<?php echo $frm; ?>" method="post" action="edicionestadisticasfacts.php#<?php echo $row["idcomputotiempoadicional"]; ?>">
                      <tr class="normal">
                        ...
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                        <td class="sdfgd"><span id="sprytextfield1">
                          <label>
                        ...
                        <span class="textfieldRequiredMsg">Se necesita un valor.</span></span></td>
                        <td class="sdfgd">
                        <a name="<?php echo $id; ?>" id="<?php echo $row["idcomputotiempoadicional"]; ?>"></a>
                        <input type="hidden" name="idcomputotiempoadicional" value="<?php echo $row["idcomputotiempoadicional"]; ?>" />
                    ...
                    <p><a href="estadisticasfacts.php?id=<?php echo $id; ?>" target="_blank"> Estadisticas finales</a></p>
