...
session_start();
$link= Conectar();
	$query = "select * from usuarios where User ='".$_SESSION['Usersession']."' and tipo='CAPTURISTA' and password='".$_SESSION['Pass']."' ";
...
if($_SESSION['Usersession']==true && $tip=="CAPTURISTA")
{?><head>
...
*/
initDhtmlgoodies_xpPane(Array('NOTICE OF READINEES','Estado de Hechos','Computo de Tiempo','Estadisticas Edo.Hechos','Reporte Previo','Reporte Gral.Status','Reporte Preliminar','Reporte de Oper. en 24 hrs','Acta de Finalizacion','Reporte por Día','Reporte por Dest. y Prod.','Reporte por Transportista','Reporte de Bodegas'),Array(false,true,false,false,false,false,false,false,false,false,false,false,false),Array('pane1','pane2','pane3','pane4','pane5','pane6','pane7','pane8','pane9','pane10','pane11','pane12','pane13'));
</script>
<!-- END OF PANE CONTENT -->
<td width="1024" height="772" valign="top"><applet code="twin.EscritorioB" width="1024" height="1200" align="top" archive="twin.jar" background="255,255,255" >
  </applet></td></tr></table>
</body>
</html>
<?php }
