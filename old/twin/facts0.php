...
<body bgcolor="#ffffff">
      <table width="830" border="1" cellspacing="2" cellpadding="0">
            <tr>
                <td bgcolor="#0183bf">
					<div align="left">
        ...
        <table width="831" border="1" cellspacing="2" cellpadding="0">
            <tr>
                <td width="823" height="130" bgcolor="#eeede5">
                            ...
                            <td width="538" class="fact">
                                <table width="493" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="538">
                                            <div align="left">
                                                <font size="2" face="Tahoma, Geneva, sans-serif"><?php echo $computotiempo; ?> <?php echo $bodega;?></font></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td class="fact">
                                <table width="493" border="0" cellspacing="2" cellpadding="0">
                                    <tr>
                                        <td>
                                            <div align="left">
                                                <font size="2" face="Tahoma, Geneva, sans-serif"><?php echo $computotiempo; ?> </font></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>                           
...
<table width="827" border="0">
          <tr>
            <td width="817"><p class="tb">SHORE DRAFT SURVEY WEIGHT  _____________________
            </p>
              <p class="tb">
                SHIPS SURVEYOR WEIGHT _____________________                </p>
              <p class="tb">
                TMA SURVEYOR WEIGHT _____________________</p>
              <p class="tb">Total shortage cargo 111.201 M.T.</p>
              <p class="tb">&nbsp;</p>
              ...
              <p class="tb">&nbsp;</p>
              <table width="799" border="0" align="center" cellspacing="0">
                <tr>
                  <td width="797" height="45"><span class="tb"><font face="Arial, Helvetica, sans-serif"><?php printf($remarks); ?></font></span></td>
                </tr>
              </table>
<p class="tb">TWIN MARINE DE MEXICO S.A. DE C.V.</p>
              ...
              <br />
              <br />
              <p class="tb">_________________________________<br />AS SHIP AGENTS ONLY</p>
