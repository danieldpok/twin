...
echo $hinicio."	".$hfinal;
                  ...
                  <?php
                            ...
                            $query = "select ".$fields." from ".$table." where id='".$id."' and fecha='".$fechax[$i]."' and tipo='ARRIVAL MANEUVERS' order by hinicial, hfinal";
                            $result = mysql_query($query, $link);
                            $buf=0;
...
echo $hinicio."	".$hfinal;
                  ...
                  <?php
                            ...
                            $query = "select ".$fields." from ".$table." where id='".$id."' and fecha='".$fechax[$i]."' and tipo='OPERATIONAL' order by hinicial, hfinal";
                            $result = mysql_query($query, $link);
...
?></td>
          ...
          <font size="-2">Powered in association  by TWIN MARINE DE MEXICO, S.A. DE C.V.  and  DAKA Technology. &lt;&lt;Copyright © 2009-2010 All Rights Reserved&gt;&gt;</font></td>
        </tr>
      </table>
</body>
