...
$pdf->setColor(.1,.1,.1);
$pdf->addText(297.5,740.5,20,'<b>STATEMENTS OF FACTS</b>');

$pdf->setColor(1,1,1);
$pdf->addText(297,740,20,'<b>STATEMENTS OF FACTS</b>');
...
$pdf->setColor(0,0,0);
$pdf->addText($x2+80,$renglon,10,'<b>'.$puerto.', MEXICO.</b>');
$renglon-=10;
...
if($type=="IMPORT") $title="RECEIVER(S):"; else $title="SHIPERS:";
...
if($titulo[$j]!=NULL and $titulo[$j]!="" and $titulo[$j]!="NULL")	{
	...
	$pdf->addText(30, $renglon-23,8,$onbehalf[$j]);
...
if($titulo[$j]!=NULL and $titulo[$j]!="" and $titulo[$j]!="NULL")	{
	$pdf->addText(215, $renglon-13,8,$titulo[$j]);
	$pdf->addText(215, $renglon-23,8,$onbehalf[$j]);
	//$pdf->rectangle(210,$renglon-40, 180,40);
	$pdf->line(210, $renglon-60, 390, $renglon-60);
	$pdf->addText(215, $renglon-70, 8,$etiqueta[$j]);
}
$j++;

if($titulo[$j]!=NULL and $titulo[$j]!="" and $titulo[$j]!="NULL")	{
	$pdf->addText(400, $renglon-13,8,$titulo[$j]);
	$pdf->addText(400, $renglon-23,8,$onbehalf[$j]);
...
$arg="<b>Powered in association by    <c:alink:www.twinmarinedemexico.com>TWIN MARINE DE MEXICO, S.A. DE C.V.</c:alink>  and  <c:alink:www.daka.com.mx>DAKA Technology.</c:alink>      <<Copyright © 2009-2010 All Rights Reserved></b>";
