...
<body class="fondo">
<p><img src="http://t1.gstatic.com/images?q=tbn:0rxhct9ZNCBZtM:http://wersemei.es/wp-content/uploads/2009/12/cartas_de_amor_01.jpg" alt=""/></p>
<p>LA CARTA DE AMOR! </p>
    ...
    <table width="528" border="0">
      ...
      <tr>
        <td><span class="texto" id="sprycheckbox9">
          ...
          Realice una selección.</span><span class="texto" id="sprytextfield4">
            <label>
      ...
      <tr>
        <td><span class="texto" id="sprycheckbox8">
          <label>
            ...
            SHORETAGE OF THE SHIPMENT:</label>
          Realice una selección.</span><span class="texto" id="sprytextfield3">
            <label>
              <input type="text" name="shoretage" id="shoretage" />
            </label>
          </span><span class="texto">MT</span></td>
      </tr>
      <tr>
        <td class="texto">
          <label>
            ...
            VESSEL DRAFT SURVEY WEIGHT:</label>
            <label>
              <input type="text" name="vesseldraft" id="vesseldraft" />
            </label>
            Se necesita un valor.MT</td>
      </tr>
      <tr>
