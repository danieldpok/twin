...
$dia2 = date("d", mktime(0, 0, 0, date('m'), date('d')+1,date('Y')));
$m2 = date("m", mktime(0, 0, 0, date('m'), date('d')+1,date('Y')));
$anio2 = date("Y", mktime(0, 0, 0, date('m'), date('d')+1,date('Y')));
...
$datacreator = array (
                    ...
                    'Creator'=>'agency@twinmarinedemexico.com',
...
//	$pdf->ezText(utf8_decode('VERACRUZ MÉXICO A . _____ DE __________________ DE __________
    $pdf->ezText(utf8_decode('VERACRUZ MÉXICO A  '.date('d').' DE '.$mes.' DE '.date('Y').''), 10, array('justification'=>'right'));
...
/*    $pdf->ezText(utf8_decode('BUQUE MOTOR:  <b><u>'.$row["vessel"].'</u></b>'), 10, array('justification'=>'right', 'spacing'=>'1.5'));
    $pdf->ezText(utf8_decode('VIAJE:  <b><u>'.$row["noviaje"].'</u></b>'), 10, array('justification'=>'right', 'spacing'=>'1.5'));
    $pdf->ezText(utf8_decode('NACIONALIDAD:  <b><u>'.$row["flag"].'</u></b>'), 10, array('justification'=>'right', 'spacing'=>'1.5'));
    $pdf->ezText(utf8_decode('MUELLE:  <b><u>'.$row["muelle"].'</u></b>'), 10, array('justification'=>'right', 'spacing'=>'1.5'));
    $pdf->ezText(utf8_decode('PROCEDENCIA:  <b><u>'.$row["lastport"].'</u></b>'), 10, array('justification'=>'right', 'spacing'=>'1.5'));
*/
    $pdf->ezText(utf8_decode(''), 30, array('justification'=>'right'));

    $pdf->ezText(utf8_decode('PARA  LOS  EFECTOS  LEGALES  PROCEDENTES,  HACEMOS  DEL  CONOCIMIENTO  DE  USTED  QUE  EL  B/M <u><b> '.$row["vessel"].'  </b></u> DE BANDERA <u><b>  '.$row["flag"].' </b></u> ARRIBARA A ESTE PUERTO, PROCEDENTE DE <u><b> '.$row["lastport"].'  </b></u> ATRACANDO AL MUELLE <u><b>   '.$row["muelle"].'   </b></u> A LAS <u><b>   '.$row["etahora"].'   </b></u> DEL DIA <u><b>   '.$row["eta"].'   </b></u> CONDUCIENDO PARA ESTE PUERTO <u><b>   '.$row["quantity"].'   </b></u> TONS. DE CARGA Y <u><b>   '.$row["pasajeros"].'   </b></u> PASAJEROS.'), 10, array('justification'=>'full', 'spacing'=>'1.5'));
...
/////////DIA DE HOY
//    $pdf->ezText(utf8_decode('VERACRUZ MÉXICO A  '.date('d').' DE '.$mes.' DE '.date('Y').''), 10, array('justification'=>'right'));
//	$pdf->ezText(utf8_decode('VERACRUZ MÉXICO A  _______ DE ______________________ DE ________'), 10, array('justification'=>'right'));
...
$pdf->addText(20,595,10,'ARRIVAL.');		$pdf->addText(145,595,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,560,10,'<b>'.$row["arrivo"].'</b>');
$pdf->addText(20,580,10,'EOSP.');		$pdf->addText(145,580,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,548,10,'<b>'.$row["eosp"].'</b> Hrs.');
   $pdf->addText(400,590,10,'IFO:');	$pdf->addText(430,590,10,'<b>____________________</b>MT'); #$pdf->addText(430,548,10,'<b>'.$row["ifo1"].'</b> MT');
$pdf->addText(20,565,10,'Anchorage.');		$pdf->addText(145,565,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,536,10,'<b>'.$row["anchorage"].'</b> Hrs.');
   $pdf->addText(400,570,10,'MDO:');	$pdf->addText(430,570,10,'<b>____________________</b>MT'); #$pdf->addText(430,536,10,'<b>'.$row["mdo1"].'</b> MT');
$pdf->addText(20,550,10,'POB');			$pdf->addText(145,550,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,524,10,'<b>'.$row["pob"].'</b> Hrs.');
   $pdf->addText(400,550,10,'FW:');	$pdf->addText(430,550,10,'<b>____________________</b>MT'); #$pdf->addText(430,524,10,'<b>'.$row["fw1"].'</b> MT');
$pdf->addText(20,535,10,'Crossed brakewaters.');$pdf->addText(145,535,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,512,10,'<b>'.$row["crossedbrakewaters"].'</b> Hrs.');
$pdf->addText(20,520,10,'First line ashore.');	$pdf->addText(145,520,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,500,10,'<b>'.$row["firstlineashore"].'</b> Hrs.');
   $pdf->addText(400,520,10,'<b><u> Draft: </u></b>');
$pdf->addText(20,505,10,'Berthed alongside');	$pdf->addText(145,505,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,488,10,'<b>'.$row["berthedalongside"].'</b> Hrs.');
   $pdf->addText(400,500,10,'FWD:');	$pdf->addText(430,500,10,'<b>____________________</b>MT'); #$pdf->addText(430,488,10,'<b>'.$row["fwd1"].'</b> Mts.');
$pdf->addText(20,490,10,'Authorities on board');$pdf->addText(145,490,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.');
   $pdf->addText(400,480,10,'AFW:');	$pdf->addText(430,480,10,'<b>____________________</b>MT'); #$pdf->addText(430,476,10,'<b>'.$row["afw1"].'</b> Mts.');
$pdf->addText(20,475,10,'Free pratique.'); 	$pdf->addText(145,475,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.');
$pdf->addText(20,460,10,'Start Discharging.');	$pdf->addText(145,460,10,'<b>'.$row["eta"].'-'.date('Y').'  /  _______:_______</b>Hrs.'); #$pdf->addText(200,452,10,'<b>'.$row["startdischarging"].'</b>Hrs.');
...
$pdf->addText(20,400,10,'Complete Discharge.');		$pdf->addText(145,400,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(200,400,10,'<b>'.$row["completedescharging"].'</b> Hrs.');
$pdf->addText(20,385,10,'Final draft Survey.');		$pdf->addText(145,385,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(200,388,10,'<b>'.$row["finaldraftsurvey"].'</b> Hrs.');
   $pdf->addText(400,400,10,'IFO:');		$pdf->addText(430,400,10,'<b>____________________</b>MT'); #$pdf->addText(430,388,10,'<b>'.$row["ifo2"].'</b> MT');
$pdf->addText(20,370,10,'Doc. On board.');		$pdf->addText(145,370,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(200,376,10,'<b>'.$row["doconboard"].'</b> Hrs.');
   $pdf->addText(400,385,10,'MDO:');		$pdf->addText(430,385,10,'<b>____________________</b>MT'); #$pdf->addText(430,376,10,'<b>'.$row["mdo2"].'</b> MT');
$pdf->addText(20,355,10,'Pilot on board.');		$pdf->addText(145,355,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(200,364,10,'<b>'.$row["pilotonboard"].'</b> Hrs.');
   $pdf->addText(400,370,10,'FW:');		$pdf->addText(430,370,10,'<b>____________________</b>MT'); #$pdf->addText(430,364,10,'<b>'.$row["fw2"].'</b> MT');
$pdf->addText(20,340,10,'Unberted from the pier.');	$pdf->addText(145,340,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(200,352,10,'<b>'.$row["unbertedfromthepier"].'</b> Hrs.');
$pdf->addText(20,325,10,'Crossed out breakewaters.');	$pdf->addText(145,325,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(200,340,10,'<b>'.$row["crossedoutbrakewaters"].'</b> Hrs.');
   $pdf->addText(400,340,10,'<b><u>Draft:</u></b>');
$pdf->addText(20,310,10,'ETA to next Port.');		$pdf->addText(145,310,10,'<b>_____-____-'.date('Y').' / ______:______</b>Hrs.'); #$pdf->addText(145,310,10,'<b><u>'.$row["etfnextport"].'    '.$row["nextportfecha"].'    '.$row["etfhora"].'</u></b>');
 ...
 **************************************/
    ...
    $pdf->addText(400,730,10,'ARRIBO: ____________:_________HRS');
    $pdf->addText(400,710,10,'FONDEO:____________:_________HRS');
    $pdf->addText(400,690,10,'CRUZO:  ____________:_________HRS');
    $pdf->addText(400,670,10,'ATRACO:____________:_________HRS');
    $pdf->addText(400,650,10,'MUELLE: <b><u>       '.$row["muelle"].'       </u></b>');
$pdf->ezText(utf8_decode('
...
$pdf->ezText(utf8_decode('
		...
		ANEXAMOS COPIAS DE LOS DOCUMENTOS QUE ANTERIORMENTE SE DETALLARON EN LA INFORMACIÓN
...
$pdf->ezText(utf8_decode('RESPECTFULLY / RESPETUOSAMENTE
...
MASTER OF THE VESSEL/CAPITAN DEL BUQUE																										
<b>'.$row["mastername"].'</b>'), 10, array('justification'=>'center'));
 ...
 **************************************/
    ...
    '), 10, array('justification'=>'right'));
$pdf->ezText(utf8_decode('<b>AVISO   DE   SALIDA</b>																										
...
<b><u>'.$row["etfnextport"].'</b></u> ZARPANDO DEL MUELLE <b><u>'.$row["muelle"].'</b></u>  A LAS _________ HRS. DEL DIA ________________________ ZARPANDO DE ESTE PUERTO CON <b><u>  '.$row["tonstrans"].'  </b></u> TONS.  DE CARGA Y  <b><u>  '.$row["pasajeros"].'  </b></u>  PASAJEROS.
...
$pdf->ezText(utf8_decode('
ETA. PTO. DESTINO <b><u>'.$row["etf"].'    '.$row["etfhora"].'</b></u> HRS
...
EL BUQUE  ZARPARA EL DIA  _____________________ A LAS <u><b> 23:00 </b></u> HORAS, DEL MUELLE <b><u>  '.$row["muelle"].'  </b></u> VERACRUZ MÉXICO A . '.date('d').' DE '.$mes.' DE '.date('Y').''), 10, array('justification'=>'full', 'spacing'=>'1.5'));
