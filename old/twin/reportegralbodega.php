...
<body bgcolor="#ffffff">
		<div align="center">
						...
						<div align="center">
							...
							<table width="493" border="1" cellspacing="2" cellpadding="0">
								<tr>
									...
									<td>
										<table width="516" border="0" cellspacing="2" cellpadding="0">
											<tr>
			...
			<table width="933" border="1" cellspacing="2" cellpadding="0">
				<tr>
                <td width="34" bgcolor="#0183bf"><font size="2" color="white" face="Tahoma"><strong>Fecha</strong></font></td>
					<td width="43" bgcolor="#0183bf"><font size="2" color="white" face="Tahoma"><strong>Bodega</strong></font></td>
					<td width="103" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Producto</strong></font></font></td>
					<td width="77" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Transportista</strong></font></font></td>
					...
					<td width="53" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>C/P</strong></font></font></td>
					<td width="72" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Ticket Bascula </strong></font></font></td>
					<td width="51" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Peso Bruto</strong></font></font></td>
					<td width="48" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Peso Tara</strong></font></font></td>
					<td width="48" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Peso Neto</strong></font></font></td>
					<td width="58" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Saco/ Granel</strong></font></font></td>
					<td width="71" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Llegada Puerto</strong></font></font></td>
					<td width="78" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Salida Puerto</strong></font></font></td>
				</tr>
				<?php
			$table = "movimientos";
			...
			$query="select $fields from $table where id='$id' and bodega='$bodega'";
			//echo $query;
			$Zmovimientos=0;
			$Zpesobruto=0;
			$Zpesotara=0;
			...
			?>
                ...
                <td><table width="72" border="0">
                  <tr>
                    <td width="56"><font size="2" face="Tahoma"><?php echo $row["fecha"];?></font></td>
                  </tr>
            </table></td>
			...
			?>
				<tr>
					...
					<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><span class="abajo"><?php echo number_format($Zpesobruto, 3);?></span></span></span></td>
					<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><span class="abajo"><?php echo number_format($Zpesotara, 3);?></span></span></span></td>
					<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><span class="abajo"><?php echo number_format($Zpesoneto, 3);?></span></span></span></td>
					<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><span class="abajo"><?php echo $Zsacogranel;?></span></span></span></td>
					<td bgcolor="#0183bf"></td>
					<td bgcolor="#0183bf"></td>
				</tr>
			</table>
