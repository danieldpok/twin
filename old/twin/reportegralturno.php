...
<body bgcolor="#ffffff">
		<div align="center">
			...
			<table width="980" border="1" cellspacing="2" cellpadding="0">
				<tr>
			...
			$query="select $fields from $table where id='$id' and fecha='$fechaq' and llegada>='$hinicial' and salida<='$hfinal'";
			//echo $query;
			$Zmovimientos=0;
			$Zpesobruto=0;
			$Zpesotara=0;
			...
			?>
                ...
                <td bgcolor="#0183bf"></td>
					...
					<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><?php echo number_format($Zpesoneto, 3);?></span></span></td>
					<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><?php echo number_format($Zsacogranel, 0);?></span></span></td>
					<td bgcolor="#0183bf"></td>
					<td bgcolor="#0183bf"></td>
				</tr>
			</table>
