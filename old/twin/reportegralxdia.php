...
$query="select $fields from $table where id='$id' and fecha='$fecha'";
...
<body bgcolor="#ffffff">
		<table width="916" border="1" cellspacing="2" cellpadding="0">
			<tr>
				<td bgcolor="#0183bf">
					<div align="center">
						<font size="+3" color="white" face="Tahoma"><strong>REPORTE DE SUPERVISION POR FECHA</strong></font></div>
				</td>
			</tr>
		</table>
		...
		<table width="969" border="1" cellspacing="2" cellpadding="0">
			<tr>
            <td bgcolor="#0183bf"><font size="2" color="white" face="Tahoma"><strong>Fecha</strong></font></td>
				...
				<td width="82" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Llegada Puerto</strong></font></font></td>
				<td width="88" bgcolor="#0183bf"><font face="Tahoma"><font size="2" color="white"><strong>Salida Puerto</strong></font></font></td>
			</tr>
			<?php
			$table = "movimientos";
            ...
            <td bgcolor="#0183bf"></td>
				...
				<td bgcolor="#0183bf" class="abajo"><span class="abajo"><span class="abajo"><span class="abajo"><?php echo number_format($Zsacogranel, 3);?></span></span></span></td>
				<td bgcolor="#0183bf"></td>
				<td bgcolor="#0183bf"></td>
			</tr>
</table>
