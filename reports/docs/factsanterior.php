...
$query = "select distinct ".$fields." from ".$table." where idop='".$id."'";
...
$query = "select ".$fields." from ".$table." where idop='".$id."'";
        ...
        <tr>
          <td><table width="831" border="1" cellspacing="2" cellpadding="0">
            ...
            <table width="831" border="1" cellspacing="2" cellpadding="0">
              <tr>
                <td height="130" bgcolor="#eeede5"><table width="790" border="0" cellspacing="2" cellpadding="0">
                  <tr class="letra">
                  ...
                  <table width="817" border="1" cellspacing="2" cellpadding="0">
                    <tr>
                      <td height="100"><table width="815" border="0">
                        <tr>
                          <td height="52"><table width="420" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                              <td><font size="2" face="Tahoma"><strong>LOADING PORT:</strong></font></td>
                              <td><input name="textfieldName" type="text" value="<?php echo $puertodecarga; ?>" size="45" readonly="readonly" /></td>
                            </tr>
                            <tr>
                          ...
                          <td><table width="384" border="0" cellspacing="2" cellpadding="0">
                            <tr>
                              <td><font size="2" face="Tahoma"><strong>DISCH. PORT:</strong></font></td>
                              <td><input name="textfieldName2" type="text" value="<?php echo $puerto; ?>, MEXICO." size="42" readonly="readonly" /></td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                          <td height="78" colspan="2"><font size="2" face="Tahoma"><strong>
                            ...
                            <table width="803" border="1" cellspacing="2" cellpadding="0" bgcolor="#FFFFFF">
                              <tr>
                                <td bgcolor="#FFFFFF"><font size="2" face="Tahoma"><strong>RECEIVER</strong></font></td>
                                <td bgcolor="#FFFFFF"><font size="2" face="Tahoma">TOTAL CARGO</font></td>
                              </tr>
                              <?php
			...
			for($j=0; $j<count($recibidor); $j++)	{
				...
				$query="select cantidad from descargarecibidor where idop='".$id."' and recibidor='".$recibidor[$j]."'  and fecha<='$date1'";
				$result = mysql_query($query, $link);
				$cantidadTotal=0;
				while($row = mysql_fetch_array($result)){
				...
				?>
                              <tr class="normal">
                                ...
                                <td bgcolor="#FFFFFF"><div align="right"> <font size="2" face="Tahoma"><?php printf("%.3f", $pesototal);?></font></div></td>
                              </tr>
                              <?php
            ...
            <table width="831" border="1" cellspacing="2" cellpadding="0">
              <tr>
                <td><table width="324" border="0" cellspacing="2" cellpadding="0">
                  <tr>
                    <td bgcolor="#0183bf"><div align="center"> <font size="2" color="white" face="Tahoma"><strong>DATE</strong></font></div></td>
                    <td bgcolor="#0183bf"><div align="center"> <font size="2" color="white" face="Tahoma"><strong>TIME</strong></font></div></td>
                  </tr>
                </table></td>
                <td><table width="493" border="0" cellspacing="2" cellpadding="0">
                  <tr>
                    <td bgcolor="#0183bf"><div align="center"> <font size="2" color="white" face="Tahoma"><strong>FACTS</strong></font></div></td>
                  </tr>
                </table></td>
              </tr>
            </table>
              ...
              <tr>
                <td><table width="822" border="0" cellspacing="0" cellpadding="0">
                  <?php
                        ...
                        $query = "select distinct fecha from computotiempo where idop='".$id."' order by fecha";
                        //echo $queryA;
                        $result = mysql_query($query, $link);
                        $j=0;
                        while($row = mysql_fetch_array($result)) {
                        ...
                        for($i=0; $i<=count($fechax); $i++) {
                            ...
                            $query = "select ".$fields." from ".$table." where idop='".$id."' and fecha='".$fechax[$i]."' and tipo='PREARRIVO' order by hinicial";
                            $result = mysql_query($query, $link);
                            $buf=0;
                            ...
                            while($row = mysql_fetch_array($result)) {
                                ...
                                ?>
                  <tr>
                    <td valign="top"><table width="327" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td><div align="left">
                        ...
                        <td align="right"><div align="right" class="fact">
                          <?php 
												if($hinicio!=$hfinal)	{
...
echo $hinicio."	".$hfinal;
                    ...
                    <td class="fact"><table width="493" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><div align="left"> <font size="2" face="Tahoma, Geneva, sans-serif"><?php echo $computotiempo; ?> <?php echo $bodega;?></font></div></td>
                      </tr>
                    </table></td>
                  </tr>
                  <?php
                            ...
                            $query = "select ".$fields." from ".$table." where idop='".$id."' and fecha='".$fechax[$i]."' and tipo='ARRIVAL MANEUVERS' order by hinicial, hfinal";
                            $result = mysql_query($query, $link);
                            $buf=0;
                            ...
                            while($row = mysql_fetch_array($result)) {
                                ...
                                ?>
                  <tr>
                    <td valign="top"><table width="325" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td><div align="left">
                          <table width="198" border="0" cellspacing="0" cellpadding="0">
                            <tr>
...
echo $hinicio."	".$hfinal;
                  ...
                  <?php
                            ...
                            $query = "select ".$fields." from ".$table." where idop='".$id."' and fecha='".$fechax[$i]."' and tipo='OPERATIONAL' order by hinicial, hfinal";
                            $result = mysql_query($query, $link);
                            ...
                            while($row = mysql_fetch_array($result)) {
                                ...
                                ?>
                  <tr>
                    <td valign="top"><table width="323" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td><div align="left">
                          <table width="198" border="0" cellspacing="0" cellpadding="0">
                            <tr>
...
echo $hinicio."	".$hfinal;
                  ...
                  <?php
                            ...
                            ///////////////// STOP/IDLE TIME
                            $query = "select ".$fields." from ".$table." where idop='".$id."' and fecha='".$fechax[$i]."' and tipo='STOP/IDLE TIME' order by hinicial";
                            $result = mysql_query($query, $link);
                            $flag=true;
                            while($row = mysql_fetch_array($result)) {
                                if($flag) {
                  ...
                  <tr>
                    ...
                    <td><table width="493" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td bgcolor="#0183bf"><div align="left"> <font size="2" color="white" face="Tahoma"><strong>STOP/IDLE TIMES:</strong></font></div></td>
                      </tr>
                    </table></td>
                  </tr>
                  <?php
                                ...
                                ?>
                  <tr>
                    <td><table width="325" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td><div align="left">
...
echo $hinicio."	".$hfinal;
                    ...
                    <td class="fact"><table width="493" border="0" cellspacing="2" cellpadding="0">
                      <tr>
                        <td><div align="left"> <font size="2" face="Tahoma, Geneva, sans-serif"><?php echo $computotiempo; ?></font></div></td>
                      </tr>
                    </table></td>
                  </tr>
                  <?php
							...
							///////////REMARKS
							$query = "select remark from remarksday where idop='".$id."' and fecha='".$fechax[$i]."'";
                            $result = mysql_query($query, $link);
                            while($row = mysql_fetch_array($result)) {								
                            ?>
                  <tr>
            ...
            <table width="828" border="1" >
              <tr>
                <td><p class="tb">SHORE DRAFT SURVEY WEIGHT  _____________________</p>
                  <p class="tb">&nbsp;</p>
                  ...
                  <p class="tb">&nbsp;</p>
                  <span class="ninguna"><?php echo nl2br($remarks); ?>
                  </p>
                  </span>
                  <p class="tb">&nbsp;</p>
                  ...
                  AS SHIP AGENTS ONLY</p>
                  <table border="0" cellspacing="4">
                    <tr>
                      <td width="268"><span class="tb">
                        <?php
$table="chargeinformation";
...
?>
                    ...
                    <tr>
                      <td height="157"><p class="tb"><?php echo $agencia; ?><br />
                        <?php echo "ON BEHALF OF $recibidor";
								//echo "$recibidor";
								?></p>
                        <br />
                        <br />
                      ...
                      <?php } else { } ?>
                      <?php if($x==1)	{?>
                      <td width="305"><p class="tb"><?php echo $agencia; ?><br />
...
$query = "select distinct estivador from ".$table." where idop='".$id."'";
...
?>
                  <p class="tb"><?php echo $recibidor; ?> <br />
                  </p>
                  <br />
                  <br />
                  <br />
...
?></td>
          ...
          <font size="-2">Powered in association  by TWIN MARINE DE MEXICO, S.A. DE C.V.  and  DAKA Technology. &lt;&lt;Copyright © 2009-2014 All Rights Reserved&gt;&gt;</font></td>
        </tr>
      </table>
</body>
